...
<template>
  <section id="build" class="relative mx-auto max-w-6xl px-5 py-28 sm:px-8 sm:py-36">
    <SectionHeading
    ...
    <div class="grid gap-5 md:grid-cols-3">
      <RevealBlock v-for="(card, i) in cards" :key="card.n" :delay="i * 120">
        <article
          class="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-surface-1/60 transition-colors duration-300 hover:border-primary/40"
        >
          <div class="h-28 overflow-hidden opacity-50 transition-opacity duration-500 group-hover:opacity-100">
